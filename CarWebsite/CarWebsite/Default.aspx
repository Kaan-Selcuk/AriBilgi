<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CarWebsite.Default" %>
...
<header class="header">
    ...
    <a href="#" class="logo"> <span>Kaan</span>wheels </a>

    <nav class="navbar">
        <a href="#home">home</a>
        <a href="#vehicles">vehicles</a>
        <a href="#services">services</a>
        <a href="#featured">futuristic</a>
...
<section class="home" id="home">
    ...
    <h3 data-speed="-2" class="home-parallax">select your dream car</h3>
...
<section class="featured" id="featured">
    ...
    <h1 class="heading"> <span>futuristic</span> cars </h1>
